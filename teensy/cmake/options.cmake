...
set(CDEFS "-DUSB_SERIAL -DLAYOUT_US_ENGLISH -DUSING_MAKEFILE -DXM_ARM -D__arm__ -DF_CPU=${TEENSY_CORE_SPEED} -D__${MCU}__  -DARDUINO=${AARDUINO} -DTEENSYDUINO=159 -D${MCU_DEF} ")
...
# -nostdlib    looks line we do need it sometimes
# 
...
set(CXXFLAGS  " -std=gnu++17 -felide-constructors -fno-exceptions -fpermissive -fno-rtti -Wno-error=narrowing  -fno-threadsafe-statics ") #-fsized-deallocation
